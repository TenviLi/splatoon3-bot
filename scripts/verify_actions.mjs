...
try {
  await runBotSmoke({
    inputs: {
      screenshot_id: 'schedules',
      channel: 'wecom',
    },
    expectedPublishedImages: Object.freeze(['schedules.png']),
  })
  await runBotSmoke({
    inputs: {
      screenshot_id: 'splatfest-jp',
      channel: 'wecom',
    },
    expectedPublishedImages: Object.freeze(['splatfest-jp.png']),
